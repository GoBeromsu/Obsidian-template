...
2. 볼트 루트의 [`Me.md`](Me.md)를 편집합니다. Summary Statement, First Principles, How I Think, Working Preferences 네 개의 `###` 섹션으로 된 한 장의 기입 워크시트이며, 각 섹션에 한국어 안내가 붙은 빈 답변 칸이 있습니다. 정식 `Me` 노트는 이것 하나입니다. 일반적인 사실만 적으십시오. 비밀, 자격 증명, 기기 경로는 넣지 마십시오.
