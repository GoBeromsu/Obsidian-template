...
- **처음부터 휴대 가능하게.** 개인 노트, 자격 증명, 플러그인 캐시, 테마 바이너리, 기기별 상태는 포함하지 않습니다. Templater · Homepage · Omnisearch · Excalidraw · Outliner · Linter 여섯 플러그인은 바이너리로 미리 설치되어 있어, 볼트를 열고 제한 모드를 끄면 바로 켜집니다. 코어 Bases는 켜져 있고 Vim 모드는 꺼져 있습니다.
