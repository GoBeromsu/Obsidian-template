...
2. Edit [`00. Inbox/me.md`](00.%20Inbox/me.md). It is one fill-in worksheet with English `##` headings (answer in either language) and the only canonical `me` note. Use generic facts. Do not put secrets, credentials, or machine paths in it.
